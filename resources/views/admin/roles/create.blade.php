        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Crear Rol</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Crear Rol</h6>
            </nav>
            ...
            <div class="card-body p-3">
                <form action="{{route('admin.roles.store')}}" method="post">
                    ...
                    <div class="form-group">
                        <label for="nombre_role">Nombre de su rol:</label>
                        <input onkeyup="show_name_product(this.value)" type="text" name="name" class="form-control form-control-border" id="nombre_role" placeholder="Nombre de su Rol">
                    </div>
