...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/virtual-reality.html">
                        ...
                        <span class="nav-link-text ms-1">Vetas</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <script src="{{ url('admin/js/chartjs.min.js') }}"></script>
    <script>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816"
        ...
        data-cf-beacon='{"rayId":"7d001f700f0b21f9","version":"2023.4.0","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}'
