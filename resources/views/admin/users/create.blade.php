            ...
            <div class="card-body">
                <form action="{{route('admin.users.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control form-control-border border-width-2" id="names" name="names" placeholder="Nombres del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="lastnames">Apellidos del usuario</label>
                        <input required type="text" class="form-control form-control-border border-width-2" id="lastnames" name="lastnames" placeholder="Apellidos del usuario *">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                            ...
                            <input required type="text" class="form-control form-control-border border-width-2" id="document_number" name="document_number" placeholder="Numero Documento *">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="phone">Telefono del usuario</label>
                        <input required type="text" class="form-control form-control-border border-width-2" id="phone" name="phone" placeholder="Telefono del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="email">Correo del usuario</label>
                        <input required type="email" class="form-control form-control-border border-width-2" id="email" name="email" placeholder="Correo del usuario *">
                    </div>
                    <div class="form-group">
