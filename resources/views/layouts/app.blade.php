...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 text-center" href="{{route('admin.dashboard')}}">
            <img src="{{url('Restabook/images/Delipizza.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('admin.bills.index')
                    <li class="nav-item">
                        <a class="nav-link   @if($_SERVER['REQUEST_URI'] === "/public/admin/bills" || $_SERVER['REQUEST_URI'] === "/public/admin/bills/create") active  @endif" href="{{route('admin.bills.index')}}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @can('admin.charts')
                <li class="nav-item">
                        <a class="nav-link  @if($_SERVER['REQUEST_URI'] === "/public/admin/charts" || $_SERVER['REQUEST_URI'] === "/public/admin/charts/create") active  @endif" href="{{route('admin.charts')}}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewbox="0 0 42 42" version="1.1"
                                     xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <span class="nav-link-text ms-1">Informe Ventas</span>
                        </a>
                    </li>
            @endcan
            ...
            <li class="nav-item">
                <a class="nav-link  " style="cursor: pointer;" onclick="document.getElementById('cerrar').submit()">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="card shadow-lg ">
        ...
        <div class="card-header pb-0 pt-3 ">
            ...
            <div class="float-start">
                ...
                <div style="display: flex;
                    background-image: url('https://rewind.riserapp.com/static/img/profile-pic-placeholder.png');
                ...
                <div class="text-center">
                    <p>{{auth()->user()->names}} {{auth()->user()->lastnames}}</p>
                    <p>{{auth()->user()->email}}</p>
                </div>
            </div>
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <form action="{{route('logout')}}" method="post" id="cerrar">
                @csrf
                <button type="submit" class="btn bg-gradient-primary w-100 px-3 mb-2 active" data-class="bg-transparent">Cerrar Sesion</button>
            </form>
        </div>
    </div>
</div>
...
<script src="{{ url('admin/js/smooth-scrollbar.min.js') }}"></script>
...
<script src="{{ url('admin/js/soft-ui-dashboard.min.js') }}"></script>
