        ...
        <div class="row ">
            <div class="col-lg-4 mb-lg-0 mb-4">
                <div class="card z-index-2">
                        <img src="{{Storage::url($product->imagen)}}" id="imagenSeleccionada" class="card-img-top img-fluid" width="278px" height="196px">
                    ...
                    <div class="card-body p-3">
                        <form action="{{route('admin.products.update', $product)}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" value="{{Storage::url($product->image)}}" name="imagen" id="imagen_producto">
                            </div>
