        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Listar Productos</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Listar Productos</h6>
            </nav>
                    ...
                    @foreach($products as $product)
                        <tr>
                            <td>
                                ...
                                {{$product->name}}</td>
                            <td style="cursor: pointer" title="{{$product->description}}">{{ Str::limit($product->description, 21, '...') }}</td>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a title="Eliminar Usuario" onclick="document.getElementById('eliminarproducto_{{ $loop->iteration }}').submit()" class=" me-2 btn btn-danger btn-company-danger">
                                        <i class="fas fa-trash-alt"></i>
                                    </a>
                                    <a title="Editar Usuario" href="{{route('admin.products.edit',$product)}}"
