        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Informe Ventas</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Informe Ventas</h6>
            </nav>
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log(salesByDayData); // Verificar los datos pasados al gráfico

            var dates = salesByDayData.map(function(item) {
                return item.date;
            });

            var totals = salesByDayData.map(function(item) {
                return item.total;
            });
            ...
            var balanceByMonthData = {!! json_encode($balanceByMonth) !!};
            console.log(balanceByMonthData); // Verificar los datos pasados al gráfico

            var months = balanceByMonthData.map(function(item) {
                return item.month;
            });

            var balances = balanceByMonthData.map(function(item) {
                return item.balance;
            });

            var balanceByMonthCtx = document.getElementById('balanceByMonthChart').getContext('2d');
            var balanceByMonthChart = new Chart(balanceByMonthCtx, {
                type: 'line',
                data: {
                    labels: months,
                    datasets: [{
                        label: 'Balance de Compras por Mes',
                        data: balances,
