                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="https://rewind.riserapp.com/static/img/profile-pic-placeholder.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                        </div>
                    </div>
                        ...
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a title="{{$user->phone}}" class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                                        ...
                                        <span class="ms-1">Telefono</span>
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a title="{{$user->state->name}}" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a  title="0" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false" tabindex="-1">
