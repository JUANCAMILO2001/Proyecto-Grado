            ...
            <div class="card-body">
                <form action="{{ route('admin.users.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control form-control-border border-width-2"
                            id="names" name="names" placeholder="Nombres del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="lastnames">Apellidos del usuario</label>
                        <input required type="text" class="form-control form-control-border border-width-2"
                            id="lastnames" name="lastnames" placeholder="Apellidos del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="lastnames">Tipo y numero de documento del Usuario</label>
                        <div class="d-flex">
                            <select class="form-select custom-select form-control-border border-width-2" name="document_type"
                            ...
                            <input required type="text" class="form-control form-control-border border-width-2"
                                id="document_number" name="document_number" placeholder="Numero Documento *">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="phone">Telefono del usuario</label>
                        <input required type="text" class="form-control form-control-border border-width-2"
                            id="phone" name="phone" placeholder="Telefono del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="email">Correo del usuario</label>
                        <input required type="email" class="form-control form-control-border border-width-2"
                            id="email" name="email" placeholder="Correo del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="password">Contraseña del usuario</label>
                        <input required type="password" class="form-control form-control-border border-width-2"
                            id="password" name="password" placeholder="Contraseña del usuario *">
                    </div>
                    <div class="form-group">
                        <label for="password">Confirmar contraseña del usuario</label>
                        <input required type="password" class="form-control form-control-border border-width-2"
                            id="password" name="password" placeholder="Confirmar contraseña del usuario *">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-select custom-select form-control-border border-width-2" name="state_id" id="state_user">
                            <option selected>--Seleccionar Estado del Usuario--</option>
